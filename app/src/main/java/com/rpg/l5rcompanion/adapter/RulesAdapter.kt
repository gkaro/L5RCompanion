...
class RulesAdapter: RecyclerView.Adapter<RulesAdapter.RulesViewHolder>() {
    ...
    private lateinit var mListener : RulesAdapter.OnItemClickListener
    ...
    class RulesViewHolder(view: View, listener: RulesAdapter.OnItemClickListener) : RecyclerView.ViewHolder(view) {
